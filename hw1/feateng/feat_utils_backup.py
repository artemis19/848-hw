...
tournaments = [
    ...
    "SCOP MS 6",
    "LOGIC",
    "Centennial (MD) Housewrite",
    "Claude Shannon Memorial Tournament",
    "YMIR",
    "Gunpei Yokoi Memorial Open (side event)",
    "CMST",
    "Chicago Open Visual Arts",
    "Illinois Novice",
    "HSAPQ ACF 3",
    "Naveed Bork Memorial Tournament",
    "St. Anselms and Torrey Pines",
    "GRAPHIC",
    "HSAPQ Tournament 9",
    "Letras",
    "VCU Open (Saturday)",
    "Illinois Open",
    "MOHIT (Thomas Jefferson)",
    "Science Non-Strosity",
    "Missiles of October",
    "Harvard Fall Tournament",
    "Weekend of Quizbowl Saturday Event",
    ...
    "Science Monstrosity",
    "WUHSAC XI",
    "Illinois Open/(Fall) Terrapin Invitational",
    "HSAPQ VHSL Regionals",
    "Harvard Fall Tournament VII",
    "WHAQ I",
    "We Have Never Been Modern",
    "Sivakumar Day Inter-Nationals",
    "PADAWAN",
    "Historature",
    "EMT",
    "Minnesota Open",
    "Spring Offensive (history tournament)",
    "Fine Arts Common Links",
    "Penn Bowl",
    "Maryland Fall",
    "MUT",
    "QuAC I",
    ...
    "HAVOC",
    "Scattergories",
    "Jacopo Pontormo (history tournament)",
    "Ladue Invitational Sprint Tournament (LIST)",
    "MELD",
    "GSAC XXV",
    "SCOP MS 5",
    "College History Bowl",
    "Minnesota Open KLEE Fine Arts",
    "PACE NSC",
    "WAO II",
    "Berkeley WIT XII",
    "Great Lakes Regional Academic Championship (GLRAC)",
    "Fall Kickoff Tournament (FKT)",
    "ICCS",
    "Maryland Spring Classic",
    "Cardinal Classic XVIII",
    "WHAQ II",
    "Chicago Open Arts",
    "Ladue Invitational Spring Tournament",
    "HSAPQ NSC 2",
    "Math Monstrosity",
    "Cheyne 1980s American History",
    "HSAPQ Tournament 10",
    "The Experiment",
    "Kentucky Wildcat",
    "BHSAT",
    "SHEIKH",
    "HSAPQ VHSL Districts",
    "SASS",
    "Aztlan Cup",
    "HSAPQ ACF 2",
    "Titanomachy",
    ...
    "The Experiment II",
    "3M: Chicago Open History",
    "RILKE",
    "ACF Novice",
    "MW GSAC XVII",
    "Prison Bowl XI",
    "HSAPQ VHSL States",
    "Geography Monstrosity 2",
    "Gaddis I",
    "VCU Open (Sunday)",
    "Gorilla Lit",
    "Lederberg Memorial Science Tournament 2: Daughter Cell",
    "KABO",
    "QUARK",
    "HSAPQ Tournament 16",
    "Penn-ance",
    "LIST (Ladue Invitational Spring Tournament)",
    "XENOPHON",
    "Geography Monstrosity",
    "St. Louis Open",
    "Cane Ridge Revival",
    "Aztlan Cup II/Brown UTT/UNC AWET",
    "Oxford Open",
    "Chicago Open",
    "HFT",
    "CALISTO",
    ...
    "VICO",
    "The Bob Loblaw Law Bowl",
    "FRENCH",
    "Minnesota Undergraduate Tournament (MUT)",
    "JAKOB",
    "Collaborative MS Tournament",
    "GSAC XXIII",
    "HFT X",
    "HSAPQ NASAT Tryout Set",
    "ILLIAC",
    "Montgomery Blair Academic Tournament (MBAT)",
    "Tyrone Slothrop Literature Singles",
    "MYSTERIUM",
    ...
    "Virginia Wahoo War",
    "IMSAnity 5",
    "Maggie Walker GSAC XIX",
    "THUNDER",
    "DRAGOON",
    "FKT",
    "HAVOC II",
    "NASAT",
    "GDS Ben Cooper Memorial",
    "Prison Bowl",
    "UIUC High School Solo",
    "VETO",
    "Gaddis II",
    "Toby Keith Hybrid",
    "Chicago Open Literature",
    "MSU/UD Housewrite",
    "FIST",
    "Maggie Walker GSAC XV",
    "BDAT I",
    "Law Bowl",
    "STIMPY",
    "BISB (Brookwood Invitational Scholars' Bowl)",
    "RAVE",
    "HFT XIV",
    "GRAB BAG",
    "Delta Burke",
    ...
    "Scattergories 2",
    "PIANO",
    "Chicago Open History Doubles",
    "A Bit of Lit",
    "Virginia J'ACCUSE!",
    "Cheyne American History People",
    "Vanderbilt ABC/2011 VCU Winter",
    "Oxford Online",
    "Matt Cvijanovich Memorial Novice Tournament",
    "The Unanswered Question",
    "HFT XI",
    "Words and Objects",
    "NHBB College Nationals",
    "History Doubles at Chicago Open",
    ...
    "Minnesota Open Lederberg Memorial Science Tournament",
    "WUHSAC VIII",
    "Richard Montgomery Blair Academic Tournament",
    "RMBCT",
    "It's Lit",
    ...
    "HSAPQ Tournament 11",
    "SMT",
    "HSAPQ National History Bowl",
    "Terrapin Invitational Tournament",
    "Bulldog High School Academic Tournament (BHSAT)",
    "Schindler's Lit",
    "HSAPQ Colonia 2",
    "Brookwood Invitational Scholars Bowl",
    "NTSS",
    "Julius Civilis Classics Tournament",
    "NNT",
    "HFT XIII",
    "Teitler Myth Singles",
    "ACF Regionals",
    "Illinois Fall Tournament",
    "LIST",
    "T-Party",
    "Peaceful Resolution",
    "Mahfouz Memorial Lit",
    "Zot Bowl",
    "MAGNI",
    "HSAPQ Tournament 15",
    "HSAPQ 4Q1",
    "Philly Cheesteak",
    "Maggie Walker GSAC XVIII",
    "Minnesota Novice Set",
    "Maggie Walker GSAC XVI",
    "Michigan Artaud",
    '"stanford housewrite"',
    "HSAPQ ACF 1",
    "BISB",
    ...
    "FILM",
    "SACK",
    "Michigan Manu Ginobili Open",
    "Mavis Gallant Memorial Tournament (Literature)",
    "Crusader Cup",
    "Princeton Buzzerfest",
    "Michigan Auspicious Incident",
    "Cheyne American History",
    "Early Fall Tournament (EFT)",
    "Sun God Invitational",
    "SUBMIT",
    "Ohio State/VCU housewrite",
    "JAMES",
    "Western Invitational Tournament",
    "BARGE",
    "Chicago John Stuart Mill",
    "Masonic",
    "Cheyne American Thought",
    "Guerrilla at ICT",
    "WORLDSTAR",
    "Chicago Open History",
    "From Here To Eternity",
    "History Bee Nationals",
    "Illinois Fall",
    "HSAPQ 4Q 1",
    "HSAPQ Tournament 17",
    "VCU Closed",
    "HSAPQ Tournament 8",
    "Illinois Wissenschaftslehre",
    "ACF Fall",
    "Spartan Housewrite",
]
years = [
