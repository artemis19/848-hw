...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        ...
        help="Positive class",
        type=str,
        default="../data/small_guess.buzztrain.jsonl",
    )
    argparser.add_argument(
        "--buzzdev",
        help="Negative class",
        type=str,
        default="../data/small_guess.buzzdev.jsonl",
    )
    argparser.add_argument(
        "--vocab",
        help="Vocabulary that can be features",
        type=str,
        default="../data/small_guess.vocab",
    )
    argparser.add_argument(
        "--model_path",
        help="Path to save the Log Reg model.",
        type=str,
        default="models/lr_buzzer.pickle",
    )
    ...
    print(
        f"Buzzer Train Accuracy: {buzzer.model.score(train_inputs, train_labels):.2f}"
    )
